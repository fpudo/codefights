...
// to a new building and live together. The building is represented
// by a rectangular matrix of rooms. Each cell in the matrix contains
// an integer that represents the price of the room. Some rooms are free
...
//  [x, 5, x, x],
//  [x, 1, x, x]]
// Note that the free room in the first row make the full column
// unsuitable for bots.
//
